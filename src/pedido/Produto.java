...
public class Produto extends JFrame {
	...
	private void deleteProduct() throws SQLException{
        ...
        try {
            ...
            con.close();
            JOptionPane.showMessageDialog(null,"N�o foi poss�vel deletar esse produto. "+e.getMessage());
        }
	}
   ...
   private void updateProduct() throws SQLException{
        ...
        try {
            ...
            con.close();
            JOptionPane.showMessageDialog(null,"Nao foi poss�vel deletar esse produto. "+e.getMessage());
        }
    }
